function test() {
    let nombres = [];
    let unNombre = prompt("Remplis le tableau de nombres. "+"\n\n"+"Fais Annuler lorsqu'il n'y a plus de nombres à saisir.");
    ...
    while (unNombre != null) {
        ...
        unNombre = prompt("Remplis le tableau de nombres. "+"\n\n"+"Fais Annuler lorsqu'il n'y a plus de nombres à saisir.");
    ...
    if (nombres.length < 1) {
        ...
        alert("Pour rappel le tableau était : " + nombres + "\n\n"+"Les entiers impairs retenus : " + entiersImpairs + "\n\n"+"Le produit est : " + produit);
    }
}
